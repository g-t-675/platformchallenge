...
if __name__ == '__main__':
    ...
    # Flask config
    # app.config['RQ_DEFAULT_URL'] = redis_url # according to the Flask docs RQ_DEFAULT_URL doesn't exist as an option
    rq.redis_url = redis_url # fix -- or else it will try to connect to 127.0.0.1 
